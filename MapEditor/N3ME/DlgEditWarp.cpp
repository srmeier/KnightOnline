...
{
	CFileDialog dlg(FALSE, "wap", "Noname", OFN_EXPLORER | OFN_LONGNAMES | OFN_OVERWRITEPROMPT, "Warp InfoÆÄÀÏ(*.wap)|*.wap||");
...
void CDlgEditWarp::OnBtnImport() 
{
	...
	CFileDialog dlg(TRUE, "wap", NULL, dwFlags, "Warp InfoÆÄÀÏ(*.wap)|*.wap||", NULL);
