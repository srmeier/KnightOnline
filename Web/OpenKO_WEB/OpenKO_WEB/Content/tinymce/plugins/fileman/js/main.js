...
function ResizeFrame(){
  if(RoxyUtils.IsMobile()){
    $('.scrollPane').css('height', 'auto').css('overflow', 'show');
    //var toolbarsHeight = window.outerHeight - window.innerHeight;
    var newHeight = $('body').outerHeight();
    ResizeForTouchDevices(window.outerWidth, newHeight);
  }
}
